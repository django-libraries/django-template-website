...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://postgres:postgres@localhost:5432/django_template_website",
    )
}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Django Template Website API",
    "DESCRIPTION": "Documentation of API endpoints of Django Template Website",
    "VERSION": "1.0.0",
